...
Описание на R5RS стандарта може да бъде намерено [тук](http://www.schemers.org/Documents/Standards/R5RS/HTML/). Там можете да намерите информация за всички форми и процедури, които използваме в курса.
